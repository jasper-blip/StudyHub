    ...
    dashboard: () => {
        ...
        return `
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem; margin-top: 1rem;">
                <div class="note-card" style="background: linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, rgba(2, 6, 23, 0.6) 100%);">
                    <div class="note-tag">Performance Insight</div>
                    <div class="note-title">Next Level: Advanced Revision</div>
                    <div class="note-body">
                        Your efficiency in <strong>Medicine Through Time</strong> is in the top 5%. Focus on 18th-century public health reforms this week to maintain your lead.
                    </div>
                    <div class="mastery-container">
                        <div class="mastery-header">
                            <span>Topic Mastery: 19th Century Surgery</span>
                            <span>92%</span>
                        </div>
                        <div class="mastery-bar">
                            <div class="mastery-fill" style="width: 92%;"></div>
                        </div>
                    </div>
                </div>
                
                <div class="note-card" style="background: linear-gradient(135deg, rgba(236, 72, 153, 0.1) 0%, rgba(2, 6, 23, 0.6) 100%);">
                    <div class="note-tag">Daily Quote</div>
                    <div class="note-title">Elite Mindset</div>
                    <div class="note-body" style="font-style: italic; border-left: 2px solid var(--secondary); padding-left: 1.5rem; margin-top: 1rem;">
...
function showToast(message) {
    ...
    toast.style.cssText = `
        ...
        gap: 0.75rem;
    `;
    toast.innerHTML = `<i data-lucide="check-circle" style="width: 20px;"></i> <span>${message}</span>`;
